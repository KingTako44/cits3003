...
glm::mat4 EditorScene::LocalTransformComponent::calc_model_matrix() const {
    glm::mat4 rotateX = glm::rotate(glm::mat4(1.0f), euler_rotation.x, glm::vec3(1.0f, 0.0f, 0.0f));
    glm::mat4 rotateY = glm::rotate(glm::mat4(1.0f), euler_rotation.y, glm::vec3(0.0f, 1.0f, 0.0f));
    glm::mat4 rotateZ = glm::rotate(glm::mat4(1.0f), euler_rotation.z, glm::vec3(0.0f, 0.0f, 1.0f));

    return glm::translate(position) * rotateY * rotateX * rotateZ * glm::scale(scale);
}
...
void EditorScene::LitMaterialComponent::add_material_imgui_edit_section(MasterRenderScene& /*render_scene*/, const SceneContext& /*scene_context*/) {
    ...
    material_changed |= ImGui::DragFloat("Diffuse Factor", &material.diffuse_tint.a, 0.01f);

    material_changed |= ImGui::ColorEdit3("Specular Tint", &material.specular_tint[0]);
    material_changed |= ImGui::DragFloat("Specular Factor", &material.specular_tint.a, 0.01f);
